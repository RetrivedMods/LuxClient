...
class ESPModule : Module("ESP", ModuleCategory.Visual) {
    ...
    private val strokeWidth by floatValue("Stroke", 2f, 1f..10f)
    private val colorRed by intValue("R", 255, 0..255)
    private val colorGreen by intValue("G", 0, 0..255)
    private val colorBlue by intValue("B", 0, 0..255)

    // Display options
    private val showAllEntities by boolValue("Entities", false)
    private val showDistance by boolValue("Distance", true)
    private val showNames by boolValue("Nametags", true)

    // Box style options
    private val use2DBox by boolValue("2D", false)
    private val use3DBox by boolValue("3D", true)
    private val useCornerBox by boolValue("CornerBox", false)
